$(document).ready(function () {
    ...
    ******************************************************************************/
    ...
    /*****************************************************************************
        FIT TEXT
    ******************************************************************************/
    $("#about h1, #services h1, #work h1,  #contact h1,  #blog h1, #features h1").fitText(0.8, { minFontSize: '68px', maxFontSize: '150px' });
    $(".lead").fitText(2.0, { minFontSize: '20px', maxFontSize: '34px' });
